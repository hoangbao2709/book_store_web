...
import { API_ADMIN_URL, API_CATALOG_URL } from "../../../config/api";
...
export default function Edit() {
    ...
    useEffect(() => {
        fetch(`${API_CATALOG_URL}/Data.php?&url=${encodeURIComponent("tat_ca_san_pham")}&variable=${encodeURIComponent(value)}`)
    ...
    return (
        <div className="w-[100%] lg justify-center content-center relative flex h-screen">
            <form className="w-[20%] z-10 content-center" action={`${API_ADMIN_URL}/update.php`} method="post" onSubmit={handleSubmit}>
                <div className="grid">
                    <div class="relative">
                        <input
                            type="text"
