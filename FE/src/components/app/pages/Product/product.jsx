...
import { API_FAVORITES_URL, API_STORE_URL } from "../../../../config/api";
...
export default function Product() {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await fetch(`${API_FAVORITES_URL}/getFavorite.php?id=${encodeURIComponent(element.id)}`);
    ...
    useEffect(() => {
        favourite ?
        fetch(`${API_FAVORITES_URL}/favorite.php?id=${encodeURIComponent(element.id)}`)
        : fetch(`${API_FAVORITES_URL}/deleteFavorite.php?id=${encodeURIComponent(element.id)}`)
    }, [favourite]); 
    ...
    function addToStore(){
        fetch(`${API_STORE_URL}/store.php?&id=${encodeURIComponent(element.id)}&sl=${soLuong}`)
    }
    ...
    console.log(`${API_STORE_URL}/store.php?&id=${encodeURIComponent(element.id)}&sl=${soLuong}`);
