...
$upload_root = '../../FE/src/components/app/BackEnd/php/images/';
$upload_dirs = [
    'kien_thuc_khoa_hoc' => $upload_root . 'kien_thuc_khoa_hoc/' . $id . '/',
    'lich_su_truyen_thong' => $upload_root . 'lich_su_truyen_thong/' . $id . '/',
    'tat_ca_san_pham' => $upload_root . 'tat_ca_san_pham/' . $id . '/',
    'truyen_tranh' => $upload_root . 'truyen_tranh/' . $id . '/',
    'van_hoc_nuoc_ngoai' => $upload_root . 'van_hoc_nuoc_ngoai/' . $id . '/',
    'van_hoc_viet_nam' => $upload_root . 'van_hoc_viet_nam/' . $id . '/',
    'wings_book' => $upload_root . 'wings_book/' . $id . '/'
];
